# 🧪 Lab Title: Snippet from my Tasks – HHTP Log Analysis
...
📥 **[Download HTTP Log file](https://github.com/samfajobi/splunk-SIEM-Log-Monitoring-Lab/blob/main/http_logs.json)**
